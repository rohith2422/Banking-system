...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="navbar-brand" href="#">IND BANK <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWprqflCC-bWT1VPIn2Pp30t9lAFMzCkjPNXkOeP-l0I7Iw9kZFiMLplln04m-6Z4pUMU&usqp=CAU" alt="Bank" width="50" height="50"></a>
...
<class class="welcome">
        <h2>
            <img src="https://m.economictimes.com/thumb/msid-64230667,width-1200,height-900,resizemode-4,imgsize-28918/mobile-transaction-thinksto.jpg" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> 
        </h2>
    </class>
